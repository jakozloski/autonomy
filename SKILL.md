...
| --------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| Claude base     | Fable 5              | The working side: explorers, delegated work, the fresh escalation voice                                                           | BLOCK      |
...
| Codex           | GPT-6 Astra          | The mandatory Phase 2 plan verdict; the standing Phase 4 diff review at every size tier (Claude substitution only on post-Phase-2 Codex loss; skill-only passes Claude-reviewed by design) | BLOCK      |
